...
#'
#' @description
#' `CalculateAmbiguity` returns the ambiguity of the triangular or trapezoidal fuzzy number (see, e.g., (Ban et al., 2015),
...
#'
#' Then for each fuzzy number, its characteristics, known as the ambiguity of fuzzy number, is calculated.
...
# calculate the ambiguity of fuzzy number

CalculateAmbiguity <- function(fuzzyNumber, increases = FALSE)
{
