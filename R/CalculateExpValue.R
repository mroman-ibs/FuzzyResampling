...
#'
#' @description
#' `CalculateExpValue` returns the expected value of the triangular or trapezoidal fuzzy number (see, e.g., (Ban et al., 2015),
...
#'
#' Then for each fuzzy number, its characteristics, known as the expected value of fuzzy number, is calculated.
...
# calculate the expected value of fuzzy number

CalculateExpValue <- function(fuzzyNumber, increases = FALSE)
{
