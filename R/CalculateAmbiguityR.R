...
#'
#' Then for each fuzzy number, its characteristics, known as the right-hand ambiguity of fuzzy number, is calculated.
...
# calculate right-hand ambiguity of fuzzy number

CalculateAmbiguityR <- function(fuzzyNumber, increases = FALSE)
{
