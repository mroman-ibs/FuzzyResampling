...
#'
#' @description
#' `CalculateWidth` returns the width of the triangular or trapezoidal fuzzy number (see, e.g., (Ban et al., 2015),
...
#'
#' Then for each fuzzy number, its characteristics, known as the width of fuzzy number, is calculated.
...
CalculateWidth <- function(fuzzyNumber, increases = FALSE)
{
