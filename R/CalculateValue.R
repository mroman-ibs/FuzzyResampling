...
#'
#' @description
#' `CalculateValue` returns the value of the triangular or trapezoidal fuzzy number (see, e.g., (Ban et al., 2015),
...
#'
#' Then for each fuzzy number, its characteristics, known as the value of fuzzy number, is calculated.
...
CalculateValue <- function(fuzzyNumber, increases = FALSE)
{
