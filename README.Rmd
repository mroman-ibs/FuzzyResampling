...
<!-- badges: start -->
[![Travis build status](https://travis-ci.com/mroman-ibs/FuzzyResampling.svg?branch=master)](https://travis-ci.com/mroman-ibs/FuzzyResampling)
...
The goal of FuzzyResampling (R package) is to provide additional resampling procedures, apart from the classical bootstrap (i.e. Efron's
